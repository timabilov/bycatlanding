...
// import {  FooterContent, FooterColumn, FooterBottom } from "@/components/ui/footer";
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-4 leading-relaxed">
                    ...
                    <Link href="/account-removal" className="text-primary hover:underline font-medium hover:text-primary/80 transition-colors">
                      here
                    </Link>{" "}
                  ...
                  <div className="inline-block rounded-lg border border-red-500/20 bg-red-500/10 px-4 py-2 text-sm font-medium text-red-600 dark:text-red-400">
                    ⚠️ Due to regulatory compliance, your data will be
